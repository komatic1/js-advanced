...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var arr = item.files[0].name.split('.'); // fljskljdflsdkjfsdlfjsd.png => [0 => 'fljskljdflsdkjfsdlfjsd', 1 => 'png']
      ...
      var name = arr[0].substring(0, 8) + dots + arr[1]; // render name
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.classList.add('animated', 'fadeOutUp'); // but it is not remove element from the screen - only hide
      ...
      postData(api, formData).then(function (res) {
        console.log(res); // change image and text
        ...
        clearInputs();
        setTimeout(function () {
          statusMessage.remove(); // show form after img remove
