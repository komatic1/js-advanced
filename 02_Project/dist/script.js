...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical'); //forms();
  ...
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_8__["default"])('.accordion-heading', '.accordion-block');
});
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      btnGrandpa = menu.querySelector('.granddad'),
  ...
  btnGrandpa.addEventListener('click', function () {
    typeFilter();
  });
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    ...
    var matrix = '+3 (___) ___ __ __',
        ...
        // we replace here NOT digits to EMPTY string
    ...
    this.value = matrix.replace(/./g, function (a) {
      //a - only variable: all symbols from string matrix
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (e.target) {
          e.preventDefault();
        } // we check here if user clicked somewhere
  ...
  function calcScroll() {
    ...
    document.body.appendChild(div); // calc scroll of window

    var scrollWidth = div.offsetWidth - div.clientWidth; // scroll width
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      // for old browser with different work mode
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // any button were pressed and user down the page
      // height of content and already scrolled >= height of page

      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeight) {
        // call MANUALLY event of modal window
        document.querySelector(selector).click(); // don't forget about 3 different mode for the browser
      }
    });
  }
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  try {
    var prevBtn = document.querySelector(prev),
        nextBtn = document.querySelector(next); // change classes during listing slider
  ...
  activateAnimation(); // pause sliders by over mouse
